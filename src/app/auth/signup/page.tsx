...
import { 
  ...
  Star, MapPin, ArrowRight, Sparkles, Compass, Check 
} from 'lucide-react'
...
export default function SignupPage() {
  ...
  // Handle OTP Digit Input Actions
  const handleOtpDigitChange = (index: number, value: string) => {
    ...
    // If fully filled, trigger submit
                ...
                >
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex items-center my-5">
                      ...
                      <span className="px-3 text-xs text-slate-500 font-bold uppercase tracking-widest">or email signup</span>
                      <div className="flex-grow border-t border-white/5"></div>
                    </div>
                  </div>
